...
available can support an SSL and HTTP(s) transport.
...
Similarly, a badly-behaved client may fail to specify codeset
information when it first uses a connection to a server, meaning that
the server does not know the transmission codeset used by the client.
...
ISO-8859-1 for char and string, and will not sent wchar and wstring.
